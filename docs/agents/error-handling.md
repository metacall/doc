...
sidebar_position: 13
description: Overview of the error handling mechanisms in MetaCall Core, explaining how errors are represented, propagated, and handled across language boundaries.
---
