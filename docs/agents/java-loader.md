...
title: Java Loader
sidebar_position: 17
description: Overview of the Java Loader as a component of the MetaCall Core that enables execution of Java code and interoperability between Java and other programming languages supported by MetaCall.
---
