...
title: Node.js Port
sidebar_position: 22
description: Overview of the description of the Node.js Port for Metacall, a component that enables Node.js applications to call functions from other programming languages.
---
