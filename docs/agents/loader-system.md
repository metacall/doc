...
title: Loader System
sidebar_position: 18
description: Overview of the Loader System as a core component of MetaCall that enables loading, executing, and interoperating with code written in different programming languages.
---
