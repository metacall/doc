...
title: Python Loader
sidebar_position: 27
description: Overview of the Python Loader is a core component of MetaCall that enables loading and executing Python code at runtime.
---
...
For information about other language loaders, see the [Loaders](./loaders.md) section.
