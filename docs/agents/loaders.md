...
title: Loaders
sidebar_position: 19
description: Overview of Loaders as a fundamental component of the MetaCall system, responsible for loading and executing code from different programming languages.
---
