...
This page provides comprehensive guidance on executing tests within the MetaCall Core project. It covers running tests locally across different platforms, using sanitizers, and navigating test output. For information about writing new tests, see [Writing Tests](/metacall/core/8.2-writing-tests).
