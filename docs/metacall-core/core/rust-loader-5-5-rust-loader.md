...
For information about the overall MetaCall loader architecture, see [Loader System](/metacall/core/2.2-loader-system). This document focuses specifically on the Rust Loader's implementation, capabilities, and configuration.
