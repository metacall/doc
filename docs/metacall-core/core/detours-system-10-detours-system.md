...
For information about the core Value System that handles data conversion between languages, see [Serialization and Value System](/metacall/core/9-serialization-and-value-system).
