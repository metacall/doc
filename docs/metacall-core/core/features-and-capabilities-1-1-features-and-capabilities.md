...
This page provides a comprehensive overview of MetaCall's core features and capabilities as a polyglot runtime environment. MetaCall enables seamless cross-language function calls, allowing developers to write and execute code in multiple programming languages within the same application. For information about specific language implementations, see [Supported Languages](/metacall/core/1.2-supported-languages).
