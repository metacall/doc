...
- For more information about the general loader system, see [Loader System](/metacall/core/2.2-loader-system)
- For information about other language loaders, see:
  - [Python Loader](/metacall/core/5.1-python-loader)
  - [Node.js Loader](/metacall/core/5.2-node.js-loader)
  - [Ruby Loader](/metacall/core/5.3-ruby-loader)
  - [Rust Loader](/metacall/core/5.5-rust-loader)
