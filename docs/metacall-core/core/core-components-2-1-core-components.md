...
For information about language-specific runtimes, see [Loader System](/metacall/core/2.2-loader-system). For information about language-specific interfaces to MetaCall, see [Port System](/metacall/core/2.3-port-system).
