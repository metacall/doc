...
For information about build system prerequisites, see [Prerequisites](/metacall/core/3.1-prerequisites). For Docker-based builds, see [Docker Builds](/metacall/core/3.3-docker-builds).
