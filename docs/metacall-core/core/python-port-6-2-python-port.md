...
For information about the Python loader (which allows calling Python functions from other languages), see the [Python Loader](/metacall/core/5.1-python-loader) page.
