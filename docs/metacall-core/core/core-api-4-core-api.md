...
This page documents the C API that serves as the foundation for all MetaCall functionality. For language-specific ports that provide native bindings, see [Ports](/metacall/core/6-ports).
