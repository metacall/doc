...
For information about running Rust code from other languages, see [Rust Loader](/metacall/core/5.5-rust-loader).
...
For a more detailed description of the underlying API functions, see the [Core API](/metacall/core/4-core-api) page.
...
- [Rust Loader](/metacall/core/5.5-rust-loader) for loading Rust code from other languages
- [Core API](/metacall/core/4-core-api) for the underlying MetaCall API
- [Port System](/metacall/core/2.3-port-system) for an overview of MetaCall ports
