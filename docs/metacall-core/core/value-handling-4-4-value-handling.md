...
For information about calling functions with these values, see [Calling Functions](/metacall/core/4.3-calling-functions). For information about how values are serialized and transferred, see [Serialization and Value System](/metacall/core/9-serialization-and-value-system).
