...
For information about the overall architecture of MetaCall, see [Architecture](/metacall/core/2-architecture).
...
For more information on using MetaCall, see [Overview](/metacall/core/1-overview) and [Architecture](/metacall/core/2-architecture).
