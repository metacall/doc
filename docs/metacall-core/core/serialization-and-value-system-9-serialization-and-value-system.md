...
For information about how values are used in function calls, see [Core API](/metacall/core/4-core-api). For information about language-specific type conversion, see [Loaders](/metacall/core/5-loaders).
