...
For information about loading and executing code from different programming languages, see the [Loader System](/metacall/core/2.2-loader-system) documentation. While loaders execute foreign code, ports provide the API for accessing MetaCall from a specific language.
